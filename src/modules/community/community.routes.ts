 ...
 *   post:
 *     summary: Create a new community post with optional images
 *     tags: [Community]
 *     security:
 *       - BearerAuth: []
 *     requestBody:
 ...
 *                   type: string
 *                   format: binary
 *                 description: Image files to attach (max 5)
 *               tags:
 *                 type: string
 *                 description: Comma-separated tags (e.g. 'wedding,embroidery')
 *         application/json:
 *           schema:
 *             type: object
 *             required: [title, content]
